...
CREATE SEQUENCE IF NOT EXISTS dragon_heads_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS locations_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS people_seq START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS admin_requests_seq START WITH 1 INCREMENT BY 1;
