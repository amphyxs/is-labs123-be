...
CREATE SEQUENCE IF NOT EXISTS dragons_seq START WITH 10 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS coordinates_seq START WITH 10 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS dragon_caves_seq START WITH 10 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS dragon_heads_seq START WITH 10 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS locations_seq START WITH 10 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS people_seq START WITH 10 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS admin_requests_seq START WITH 10 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS users_seq START WITH 10 INCREMENT BY 1;
